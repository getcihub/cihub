...
These folders contain the code for the different databases supported by CIHub.
They contain the SQL necessary to create the necessary tables and migrate between versions (IE the DDL).
This SQL is generated into a go file and included as part of the CIHub binary.
...
If you have [just](https://github.com/casey/just), you can also use the command:
