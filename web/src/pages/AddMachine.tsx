                            ...
                            {!autoDetect && (
                                <>
                                    ...
                                    <div>
                                        ...
                                        />
                                        <p className="text-sm text-gray-500 mt-1">
                                            Maximum number of CPU cores to limit
                                            the machine (leave empty to not set
                                            a limit)
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            ...
                                            to limit the machine (leave empty to
                                            not set a limit)
                                        </p>
                                    </div>
                                </>
                ...
                <>
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-green-800 mt-1">
                                    Machine "{formData.name}" has been created.
                                    Copy the installation command below and run
                                    it on your machine.
                                </p>
                            </div>
                        </div>
                    ...
                    <Card className="p-6 border-amber-200 bg-amber-50">
                        ...
                        <p className="text-sm text-amber-800 mb-3">
                            Keep this token secure. You will need it to
                            authenticate the agent on this machine.
                        </p>
                        <div className="flex gap-3">
                    ...
                    <Card className="p-6">
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                            Run the following command on your machine to install
                            the CIHub agent:
                        </p>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">
                                            ...
                                            above to copy the installation
                            ...
                            <div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">
                                            SSH into your machine and paste the
                                            command. The script will download
                                            and install the CIHub agent
                                            automatically.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">
                                            Once the script completes, the
                                            machine should appear in your
                                            machines list with status "online".
                                        </p>
                                    </div>
                                </div>
                            </div>
