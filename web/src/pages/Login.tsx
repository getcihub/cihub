...
export function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center px-4 lg:px-6">
                                ...
                                <div className="flex gap-2">
                                    {Array.from({ length: 10 }, (_, index2) => (
                                        <div key={`inner-${index}-${index2}`}>
                                            <div className="size-7 rounded-md shadow shadow-indigo-500/40 ring-1 ring-black/5" />
                                        </div>
                                    ))}
                                </div>
                            </div>
