                    ...
                    {activeSection === 'billing' && (
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-gray-600 text-sm mt-1">
                                    Monitor usage and manage billing information
                                </p>
                            </div>
                            <div>
                                {(() => {
                                    const plan = getPlanConfig(
                                        selectedInstallation?.stripe_product_id,
                                    );
                                    const isFree = plan.id === 'Free';
                                    const machinesPercent = Math.round(
                                        (machines_used / plan.max_machines) *
                                            100,
                                    );
                                    const vcpuPercent = Math.round(
                                        (vcpu_used / plan.max_vcpu) * 100,
                                    );

                                    const getMachinesBarColor = () => {
                                        if (machinesPercent >= 90)
                                            return 'bg-red-600';
                                        if (machinesPercent >= 70)
                                    ...
                                    return (
                                        <>
                                            {/* Current Plan */}
                                            <Card
                                                className={`p-6 mb-6 ${isFree ? 'bg-gray-50 border-gray-200' : 'bg-blue-50 border-blue-200'}`}
                                            >
                                                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                                                    Current Plan
                                                </h3>
                                                <div className="space-y-4">
                                                    <div
                                                        className={`flex items-center justify-between p-4 rounded-lg border ${isFree ? 'bg-white border-gray-200' : 'bg-blue-100 border-blue-300'}`}
                                                    >
                                                        <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                                                            <div
                                                                ...
                                                                style={{
                                                                    width: `${Math.min(machinesPercent, 100)}%`,
                                                                }}
                                                            />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                                                            <div
                                                                ...
                                                                style={{
                                                                    width: `${Math.min(vcpuPercent, 100)}%`,
                                                                }}
                                                            />
                                                        </div>
                                                    </div>
